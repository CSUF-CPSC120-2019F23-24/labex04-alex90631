...
int main()
{
  ...
  char my_char2 = 'C';
  my_char2 = static_cast<int>(my_char2) + 1;
  ...
  char my_char3 = 'z';
  my_char3 = static_cast<int>(my_char3) + 1;// in ASCII the symbol after z is no longer alphabetic hence it defaults to {
  ...
  my_short2 = my_short2 + 1;  //adding 1 surpasses its range and turns it into a negative
  std::cout << ", after adding 1: " << std::dec << my_short2 // adding 1 does not surpass its range
  ...
  std::cout << ", after adding 1: " << std::dec << my_short3 //adding 1 surpasses its range and turns it into a zero
    << std::hex << " (0x" << my_short3 << ")\n"; // adding 1 does not surpass its range
